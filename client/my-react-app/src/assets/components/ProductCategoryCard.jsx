    ...
    <div>
      <div style={{
        ...
        {paginated?.length > 0 ? (
          paginated.map((value) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* Image */}
                  <div style={{ position: "relative", padding: "16px", backgroundColor: "#f8f8f8" }}>
                    <img
                      src={value.image}
                  ...
                  <div style={{ padding: "12px" }}>
                    <h3 style={{
                      ...
                      margin: "0 0 8px 0", lineHeight: "1.4", height: "40px",
                    ...
                    <div style={{ marginBottom: "8px" }}>
                      <div style={{ fontSize: "18px", fontWeight: "700", color: "#E30019", marginBottom: "4px" }}>
                    ...
                    <div style={{
                      fontSize: "12px", color: "#2673DD", backgroundColor: "#E8F2FF",
                    ...
                    {value.brandId?.brandName && (
                      <div style={{
                        fontSize: "11px", color: "#999", marginTop: "8px",
          ...
          <p style={{ width: "100%", textAlign: "center", color: "#999", padding: "40px" }}>
            Không có sản phẩm để hiển thị
          </p>
        )}
      </div>

      {/* Phân trang — dùng component PaginationButton.jsx */}
      <Pagination
        current={page}
